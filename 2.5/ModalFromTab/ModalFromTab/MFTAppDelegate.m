...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    viewController1 = [[MFTFirstViewController alloc] initWithNibName:@"MFTFirstViewController" bundle:nil];
    viewController2 = [[MFTSecondViewController alloc] initWithNibName:@"MFTSecondViewController" bundle:nil];
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController
{
    if (viewController == [self.tabBarController.viewControllers objectAtIndex:1]) {
        UIViewController *secondViewController = [[MFTSecondViewController alloc] init];
        
        UIViewController *controller = [[UIViewController alloc] init];
        
        [[self.tabBarController.viewControllers objectAtIndex:1] presentViewController:controller animated:YES completion:nil];
